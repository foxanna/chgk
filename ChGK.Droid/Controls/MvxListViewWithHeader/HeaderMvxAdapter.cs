...
namespace ChGK.Droid.Controls.MvxListViewWithHeader
{
    ...
    public class HeaderMvxAdapter : HeaderViewListAdapter, IMvxAdapter
    {
        ...
        public HeaderMvxAdapter(IList<ListView.FixedViewInfo> headers, IList<ListView.FixedViewInfo> footers,
            IMvxAdapter adapter)
        ...
        {
            return (position > HeadersCount - 1 && position - HeadersCount < _adapter.Count - FootersCount + 1) &&
                   base.IsEnabled(position);
        }
    }
}